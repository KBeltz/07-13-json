...
DATABASE.execute("CREATE TABLE IF NOT EXISTS links (id INTEGER PRIMARY KEY, url TEXT, assignment_id INTEGER, FOREIGN KEY (assignment_id) REFERENCES assignments(id));")
