...
DATABASE.execute("CREATE TABLE IF NOT EXISTS links (id INTEGER PRIMARY KEY, url TEXT);")

DATABASE.execute("CREATE TABLE IF NOT EXISTS collaborators (id INTEGER PRIMARY KEY, name TEXT);")
